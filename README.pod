...
Use F<.md> for Markdown files. They will be formatted to HTML by the script. Files
ending in F<.htm>, F<.html>, F<.xhtml>, or F<.xml> will be copied verbatim. Don't include
the tag in the file where the content will go, though. For example, omit C<<body>>
...
=item head.css code to be included in the head.
